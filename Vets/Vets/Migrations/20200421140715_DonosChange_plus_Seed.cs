    ...
    public partial class DonosChange_plus_Seed : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Donos",
                columns: new[] { "ID", "NIF", "Nome" },
                values: new object[,]
                {
                    { 1, "813635582", "Luís Freitas" },
                    { 2, "854613462", "Andreia Gomes" },
                    { 3, "265368715", "Cristina Sousa" },
                    { 4, "835623190", "Sónia Rosa" },
                    { 5, "751512205", "António Santos" },
                    { 6, "728663835", "Gustavo Alves" },
                    { 7, "644388118", "Rosa Vieira" },
                    { 8, "262618487", "Daniel Dias" },
                    { 9, "842615197", "Tânia Gomes" },
                    { 10, "635139506", "Andreia Correia" }
                });
